                  ...
                  <Grid container justifyContent="flex-end">
                    <Grid item sx={{ marginTop: "1%" }}>
                      <ControlPointDuplicateOutlinedIcon
                        ...
                        type="button"
                        onClick={() =>
                          item.append(item.appendObject)
                        }
                      />
                    </Grid>
                  </Grid>
                  {fieldsMalts.map((field, fieldIndex: any) => {
                    return (
                      <Grid container key={field.id} spacing={1}>
                        <Grid item xs={1} sx={{ marginTop: "1%", height: "70px" }}>
                          <IndeterminateCheckBoxOutlinedIcon
                            fontSize="large"
                            type="button"
                            onClick={() => item.remove(fieldIndex)}
                          />
                        </Grid>
                        <Grid item xs={5}>
                          <InputAutoCompleteRestfulOptions2
                            ...
                            index={fieldIndex}
                            field={field}
                            name={`${item?.fieldArray?.ingredient}.${fieldIndex}.${item?.fieldArray?.selected}`}
                            label={`${item?.InputAutoCompleteRestfulOptions2?.label}`}
                            rules={{ required: false }}
                            restfulCall={`${item?.InputAutoCompleteRestfulOptions2?.restfulCall}`}
                            options={[]}
                            objectLabel={`${item?.InputAutoCompleteRestfulOptions2?.objectLabel}`}
                          />
                        </Grid>
                        <Grid item xs={4}>
                          <InputTextField
                            control={control}
                            name={`malts.${fieldIndex}.quantity`}
                            label="Quantity"
                            rules={{ required: true }}
                            type={"number"}
                          />
